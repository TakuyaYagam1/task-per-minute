...
func InitializeApp(ctx context.Context, cfg *config.Config, log logkit.Logger) (*App, func(), error) {
	...
	server := provideRESTServer(playerUsecase, authUsecase, taskUsecase, adminPlayerUsecase, adminPlayerEventsPostgres, uploadUsecase, leaderboardUsecase, readUsecase, healthChecks, loginRateLimiter, wireAdminRefreshRateLimiter, joinRateLimiter, log)
